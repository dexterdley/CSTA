...
class SumMeGoogleNetDataset(Dataset):
    ...
    def __init__(self, 
        ...
        """
        A simple baseline dataloader for Summe Video Dataset
    ...
    def __getitem__(self, index):
        ...
        # std = full_features.std(dim=1, keepdim=True)
        # full_features = (full_features - mean) / (std + 1e-6)
